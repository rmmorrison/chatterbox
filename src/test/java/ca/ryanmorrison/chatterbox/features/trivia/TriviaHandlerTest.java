...
class TriviaHandlerTest {
    ...
    @Test
    void buildsOneAnswerButtonPerChoiceWithRoundIdAndIndex() {
        List<Button> buttons = TriviaHandler.buildAnswerButtons(
                "rid12345",
    ...
    void buttonLabelsAreTruncatedToFitDiscordLimit() {
        ...
        List<Button> buttons = TriviaHandler.buildAnswerButtons("rid12345", List.of(longAnswer));
    ...
    void booleanRoundsRenderTwoButtons() {
        List<Button> buttons = TriviaHandler.buildAnswerButtons("rid12345", List.of("True", "False"));
